...
class Language implements \ArrayAccess
{
	 ...
	 * @param integer|string $precision Number of places to show after decimal point or word "size" for file size. Use -1 to get unchanged decimal precision
	 *
	...
	public function currencyFormat($value, $symbol, $desiredPrecision = 2, $format = null): string
	{
		...
		$v = floatval($value);
		if ($desiredPrecision == 0 && floor($v) !== $v)
		{
