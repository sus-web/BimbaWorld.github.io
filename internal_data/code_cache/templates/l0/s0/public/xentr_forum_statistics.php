...
<div class="xentr-main block">
	<div class="col-sm-12 col-md-6 col-lg-3">
		<div class="card">
			<div class="card-body">
				<div class="xentr_stats_title">' . 'Threads' . '</div>
	...
	<div class="col-sm-12 col-md-6 col-lg-3">
		<div class="card">
			<div class="card-body">
				<div class="xentr_stats_title">' . 'Messages' . '</div>
				<h2 class="stats-content">
	...
	<div class="col-sm-12 col-md-6 col-lg-3">
		<div class="card">
			<div class="card-body">
				<div class="xentr_stats_title">' . 'Members' . '</div>
				<h2 class="stats-content">
	...
	<div class="col-sm-12 col-md-6 col-lg-3">
		<div class="card">
			<div class="card-body">
				<div class="xentr_stats_title">' . 'Latest member' . '</div>
				<h2 class="stats-content">
