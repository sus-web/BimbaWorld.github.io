	...
	if ($__vars['user']['user_id']) {
		...
		if ($__vars['extras']['register_date']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Joined', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['message_count']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Messages', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['reaction_score']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Reaction score', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['trophy_points'] AND $__vars['xf']['options']['enableTrophies']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Points', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['age'] AND $__vars['user']['Profile']['age']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Age', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['location'] AND $__vars['user']['Profile']['location']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Location', array(array('for_attr', array()),), true) . '">
