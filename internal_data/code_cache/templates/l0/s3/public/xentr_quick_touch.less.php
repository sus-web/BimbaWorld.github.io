<?php
// FROM HASH: 37561e0d4029e9a4ad264a755335e78f
return array(
...
';
	if ($__templater->func('property', array('xentr_mobileQuickTouch', ), false)) {
		$__finalCompiled .= '
@media (max-width: ' . ($__templater->func('property', array('xentr_quickTouchMobileWidth', ), false) - 1) . 'px ) 
{
	#quick-touch-page-content {
		display: none;
	}
