<?php
// FROM HASH: 8fbcb7dff5e6a2b30ead3d48064b007f
return array(
...
';
	if ($__templater->func('property', array('uix_iconFontFamily', ), false) == 'material') {
		$__finalCompiled .= '
	' . $__templater->includeTemplate('uix_materialVars_solid.less', $__vars) . '
';
	}
	$__finalCompiled .= '

';
	if ($__templater->func('property', array('uix_iconFontFamily', ), false) == 'materialOutline') {
		$__finalCompiled .= '
	' . $__templater->includeTemplate('uix_materialVars_outline.less', $__vars) . '
';
	}
	$__finalCompiled .= '
