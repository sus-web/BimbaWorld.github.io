<?php
// FROM HASH: dabcc90cf4e8bfda9f3e92569c1b6895
return array(
...
';
	...
	';
	if ($__templater->func('property', array('uix_swipeSupport', ), false)) {
		$__finalCompiled .= '
		';
		$__templater->includeJs(array(
			'src' => $__templater->func('js_url', array('vendor/hammer/hammer.min.js', ), false),
		));
		$__finalCompiled .= '
		';
		$__templater->inlineJs('
