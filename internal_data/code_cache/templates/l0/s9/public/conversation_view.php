<?php
// FROM HASH: 501f2dcf6ec76bd604c95043adb3c8cd
return array(
			...
			if ($__vars['recipient']['User']) {
				$__compilerTemp3 .= '
								...
								<div class="contentRow-main">
									';
				if (($__vars['recipient']['last_read_date'] >= $__vars['conversation']['last_message_date']) AND $__templater->func('property', array('xentr_conversation_view', ), false)) {
					$__compilerTemp3 .= '
										' . $__templater->fontAwesome('fa-check', array(
						'class' => 'likeIcon',
						'data-xf-init' => 'tooltip',
						'title' => $__templater->filter('Conversation as read', array(array('for_attr', array()),), false),
					)) . '
									';
				}
				$__compilerTemp3 .= '
									';
				if (($__vars['recipient']['last_read_date'] >= $__vars['conversation']['last_message_date']) AND $__templater->func('property', array('xtr_conversation_view', ), false)) {
					$__compilerTemp3 .= '
										' . $__templater->fontAwesome('fa-check', array(
						'class' => 'likeIcon',
						'data-xf-init' => 'tooltip',
						'title' => $__templater->filter('xtr_checkmark_conversation_read', array(array('for_attr', array()),), false),
					)) . '
									';
				}
				$__compilerTemp3 .= '
