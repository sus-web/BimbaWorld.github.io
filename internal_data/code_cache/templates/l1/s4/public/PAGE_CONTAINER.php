...
';
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND $__vars['xf']['session']['unapprovedCounts']['total']) {
		$__compilerTemp1 .= '
					<a href="' . $__templater->func('link', array('approval-queue', ), true) . '" class="p-staffBar-link badgeContainer badgeContainer--highlighted" data-badge="' . $__templater->filter($__vars['xf']['session']['unapprovedCounts']['total'], array(array('number', array()),), true) . '">
						<i class="fas fa-user-lock"></i> ' . 'Approval queue' . '
					</a>
				';
	}
	$__compilerTemp1 .= '
	...
	if ($__vars['xf']['visitor']['is_moderator']) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->func('link', array('approval-queue', ), true) . '" class="menu-linkRow"><i class="fas fa-user-lock"></i> ' . 'Approval queue' . '</a>
							';
	}
	$__compilerTemp2 .= '
							';
	...
	if (strlen(trim($__compilerTemp2)) > 0) {
		$__compilerTemp1 .= '
					<a class="p-staffBar-link menuTrigger" data-xf-click="menu" data-xf-key="alt+m" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true"><i class="fas fa-user-shield"></i> ' . 'Moderator' . '</a>
					<div class="menu" data-menu="menu" aria-hidden="true">
						<div class="menu-content">
							<h4 class="menu-header"><i class="fas fa-tools"></i> ' . 'Moderator tools' . '</h4>
							' . $__compilerTemp2 . '
						</div>
					</div>
				';
	...
	if ($__vars['xf']['visitor']['is_admin']) {
		$__compilerTemp1 .= '
					<a href="' . $__templater->func('base_url', array('admin.php', ), true) . '" class="p-staffBar-link" target="_blank"><i class="fas fa-user-cog"></i> ' . 'Admin' . '</a>
				';
	}
	$__compilerTemp1 .= '
				';
...
<footer class="p-main-footer" id="footer">
	<div class="p-footer-inner">
		...
		if ($__vars['xf']['homePageUrl']) {
			$__finalCompiled .= '
						<li><a href="' . $__templater->escape($__vars['xf']['homePageUrl']) . '"><i class="fas fa-home"></i> ' . 'Home' . '</a></li>
					';
		}
		$__finalCompiled .= '
