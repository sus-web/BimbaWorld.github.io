...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="u-inputSpacer">
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_cws">' . 'Watch content on creation' . '</label></dt>
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_iws">' . 'Watch content on interaction' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
