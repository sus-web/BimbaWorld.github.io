<?php
// FROM HASH: 2d58790ae22dbd8f799b408a549a8207
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="forum-node-icon">
		...
		<div class="forum_stats">
			...
			<span class="node-icon-phrase">' . 'Threads' . '</span>
		</div>
	</div>
	';
	} else {
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '	
				<a href="' . $__templater->func('link', array('forums/post-thread', $__vars['node'], ), true) . '" class="menu-linkRow"><i class="fal fa-plus"></i> ' . 'Post thread' . $__vars['xf']['language']['ellipsis'] . '</a>
			';
	}
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('threads/latest', $__vars['extras']['LastThread'], ), true) . '" class="menu-linkRow"><i class="fad fa-comments-alt"></i> ' . 'Last activity' . '</a>
		</div>
	</div>
	</div>
</div>
