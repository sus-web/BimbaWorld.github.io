<?php
// FROM HASH: 00ee14d2056e78d45a45dec927027927
return array(
...
' . $__templater->includeTemplate('xtr_theme.less', $__vars) . '
' . $__templater->includeTemplate('xtr_base.less', $__vars) . '
' . $__templater->includeTemplate('xtr_nodes.less', $__vars) . '
' . $__templater->includeTemplate('xtr_extra.less', $__vars);
