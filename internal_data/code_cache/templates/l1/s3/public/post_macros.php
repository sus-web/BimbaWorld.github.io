...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->func('property', array('xentr_user_info_block_collapse', ), false) == 'yes') {
		$__finalCompiled .= '
				<li><span id="collapse-' . $__templater->escape($__vars['post']['post_id']) . '" class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-xf-init="tooltip" title="' . 'User details' . '" data-target="#js-post-' . $__templater->escape($__vars['post']['post_id']) . ' .message-userExtras"></span></li>
			';
	}
	$__finalCompiled .= '
			<li>
