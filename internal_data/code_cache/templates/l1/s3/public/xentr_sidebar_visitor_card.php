	...
	<div class="block-container">
			...
			$__finalCompiled .= '
					<div class="reaction-stats">
						<div class="reaction-stat">
							<i class="' . $__templater->escape($__vars['xf']['options']['xentr_reaction_score_icon']) . '" data-xf-init="tooltip" title="' . 'Reaction score' . '"></i>
		...
		if ($__vars['xf']['options']['xentr_trophy_points']) {
			$__finalCompiled .= '		
					<div class="reaction-stats">
						<div class="reaction-stat">
							<i class="' . $__templater->escape($__vars['xf']['options']['xentr_trophy_points_icon']) . '" data-xf-init="tooltip" title="' . 'Trophy points' . '"></i>
							<div class="reaction-stat-count">
		...
		if ($__vars['xf']['options']['xentr_messages']) {
			$__finalCompiled .= '
					<div class="reaction-stats">
						<div class="reaction-stat">
							<i class="' . $__templater->escape($__vars['xf']['options']['xentr_messages_icon']) . '" data-xf-init="tooltip" title="' . 'Messages' . '"></i>
							<div class="reaction-stat-count">
		...
		if ($__vars['xf']['options']['xentr_question_solution'] AND $__vars['xf']['visitor']['question_solution_count']) {
			$__finalCompiled .= '
					<div class="reaction-stats">
						<div class="reaction-stat">
							<i class="' . $__templater->escape($__vars['xf']['options']['xentr_question_solution_icon']) . '" data-xf-init="tooltip" title="' . 'Solutions' . '"></i>
							<div class="reaction-stat-count">
