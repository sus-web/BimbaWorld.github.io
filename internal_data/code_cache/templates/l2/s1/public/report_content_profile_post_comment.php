	...
	';
		...
		<div class="block-row block-row--separated block-row--minor">
			<dl class="pairs pairs--inline">
				<dt>' . 'Сообщение профиля' . '</dt>
				<dd><a href="' . $__templater->func('link', array('profile-posts', $__vars['report']['content_info'], ), true) . '">' . 'Сообщение в профиле пользователя ' . $__templater->escape($__vars['report']['content_info']['profileUser']['username']) . '' . '</a></dd>
			</dl>
		</div>
	';
		}
...
';
	...
	<div class="block-row block-row--separated block-row--minor">
		<dl class="pairs pairs--inline">
			<dt>' . 'Сообщение профиля' . '</dt>
			<dd><a href="' . $__templater->func('link', array('profile-posts', $__vars['report']['content_info'], ), true) . '">' . 'Сообщение в профиле пользователя ' . $__templater->escape($__vars['report']['content_info']['profile_username']) . '' . '</a></dd>
		</dl>
	</div>
';
	}
