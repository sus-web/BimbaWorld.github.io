...
{
	$__finalCompiled = '';
	$__finalCompiled .= 'Ваша тема ' . $__templater->escape($__vars['extra']['title']) . ' была объединена с ' . ($__templater->func('prefix', array('thread', $__vars['extra']['prefix_id'], 'plain', ), true) . $__templater->escape($__vars['extra']['targetTitle'])) . '.' . '
';
