			...
			<template class="js-installTemplateIOS">
				...
				<div class="block-body">
					<div class="block-row">
						...
						<p>
							<small><strong>' . 'Примечание' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'This feature currently requires accessing the site using the built-in Safari browser.' . '</small>
						</p>
					</div>
				</div>
			</template>
