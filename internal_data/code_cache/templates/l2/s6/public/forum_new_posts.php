...
';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageH1'] = $__templater->preEscaped('Новые сообщения');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->callMacro('dcs_sticked_threads', 'threads_list', array(
		'threads' => $__vars['sticked_threads'],
	), $__vars) . '
