...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
';
	$__templater->setPageParam('uix_mobileActiveNav', 'Поиск');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->func('link', array('search', ), true) . '" class="tabs-tab' . ((!$__vars['type']) ? ' is-active' : '') . '">' . 'Поиск по всему форуму' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</span>
		</h2>
