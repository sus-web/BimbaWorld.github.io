...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['shared']) {
		...
		$__finalCompiled .= '
				<div class="block-body block-row">' . 'Совпадений не найдено.' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Общие IP пользователя ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
