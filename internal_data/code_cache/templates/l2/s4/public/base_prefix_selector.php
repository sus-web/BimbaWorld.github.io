...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['prefixesGrouped'], 'empty', array())) {
		...
		$__compilerTemp1 = array(array(
			'value' => '0',
			'label' => $__vars['xf']['language']['parenthesis_open'] . 'Без префикса' . $__vars['xf']['language']['parenthesis_close'],
			'_type' => 'option',
		));
				...
				if (($__templater->func('count', array($__vars['prefixesGrouped'][$__vars['prefixGroupId']], ), false) > 0)) {
					if (($__vars['prefixGroupId'] > 0)) {
						...
						$__compilerTemp1[] = array(
							'value' => '',
							'disabled' => 'disabled',
							'label' => $__vars['xf']['language']['parenthesis_open'] . 'Без группы' . $__vars['xf']['language']['parenthesis_close'],
							'_type' => 'option',
						);
					}
