...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__vars['hideFollowed']) {
		$__compilerTemp1[] = array(
			'value' => 'followed',
			'label' => 'Люди, на которых я подписан(а)',
			'_type' => 'option',
		);
	}
	$__compilerTemp1[] = array(
...
';
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewProfilePosts', array())) {
		$__compilerTemp1 .= '
			...
			'label' => 'Оставлять сообщения на странице Вашего профиля',
			'hideEveryone' => true,
		), $__vars) . '
				';
	}
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		$__compilerTemp2 .= '
			...
			'label' => 'Получать Вашу новостную ленту',
		), $__vars) . '
				';
	}
	...
	<div class="block-container">
		...
		'label' => 'Просматривать детальную информацию о Вас на странице профиля',
	), $__vars) . '
		...
		'label' => 'Начинать с Вами переписки',
		'hideEveryone' => true,
	), $__vars) . '
		...
		'label' => 'Просматривать Ваши средства коммуникации',
	), $__vars) . '
			', array(
