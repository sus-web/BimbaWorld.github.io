...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['navigation'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить элемент навигации');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		' . 'Этот элемент навигации был изменён. Когда связанный с ним плагин будет обновлён, Ваши изменения будут сохранены.' . '
	</div>
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="blockMessage blockMessage--warning">
		' . 'Пользовательские изменения для этого элемента навигации будут сохраняться через обновление плагина.' . '
	</div>
';
	}
	$__finalCompiled .= '
