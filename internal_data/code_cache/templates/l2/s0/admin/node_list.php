					...
					'html' => '
								...
								<div class="menu" data-menu="menu" aria-hidden="true">
									<div class="menu-content">
										...
										<a href="' . $__templater->func('link', array('nodes/add', null, array('parent_node_id' => $__vars['node']['parent_node_id'], ), ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Родительский' . '</a>
										<a href="' . $__templater->func('link', array('nodes/add', null, array('parent_node_id' => $__vars['node']['node_id'], ), ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Дочерний' . '</a>
									</div>
								</div>
							',
				);
