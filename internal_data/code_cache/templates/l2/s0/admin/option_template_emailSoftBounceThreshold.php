...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<dl class="inputLabelPair">
		<dt><label for="' . $__templater->escape($__vars['inputName']) . '_0">' . 'Минимальное количество отказов в доставке' . '</label></dt>
	...
	<dl class="inputLabelPair">
		<dt><label for="' . $__templater->escape($__vars['inputName']) . '_1">' . 'Минимальное количество дней с отказами в доставке' . '</label></dt>
		<dd>' . $__templater->formNumberBox(array(
	...
	<dl class="inputLabelPair">
		<dt><label for="' . $__templater->escape($__vars['inputName']) . '_2">' . 'Минимальное количество дней между самым первым и самым последним отказом в доставке' . '</label></dt>
		<dd>' . $__templater->formNumberBox(array(
