...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Предварительный просмотр ленты');
	$__finalCompiled .= '
';
	$__templater->pageParams['pageH1'] = $__templater->preEscaped('
	' . 'Предварительный просмотр ленты' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->escape($__vars['feed']['url']) . '" target="_blank">' . $__templater->escape($__vars['feed']['title']) . '</a>
');
	$__finalCompiled .= '
