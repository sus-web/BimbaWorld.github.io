...
' . $__templater->formCheckBoxRow(array(
	...
	array(
		...
		'label' => 'Ожидает одобрения модератором',
		'_type' => 'option',
	),
	array(
		'value' => 'rejected',
...
' . $__templater->formCheckBoxRow(array(
	...
	array(
		...
		'label' => 'Статус участника команды форума',
	)) . '
...
' . $__templater->formCheckBoxRow(array(
		...
		'label' => 'Электронные письма о сводках активности отключены',
		'_type' => 'option',
	),
	array(
		'value' => '1',
		'selected' => $__templater->func('in_array', array(1, $__vars['criteria']['activity_summary'], ), false),
		'label' => 'Электронные письма о сводках активности включены',
		'_type' => 'option',
	)), array(
		'label' => 'Электронные письма со сводкой активности',
	)) . '
