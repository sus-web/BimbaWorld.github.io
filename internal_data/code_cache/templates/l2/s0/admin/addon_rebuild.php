...
';
	...
	if ($__vars['errors']) {
		...
		$__compilerTemp1 .= '
					' . 'Пожалуйста, ознакомьтесь с предупреждениями и подтвердите то, что Вы хотите продолжить перестроение мастер-данных следующих плагинов' . $__vars['xf']['language']['label_separator'] . '
				';
	} else {
		$__compilerTemp1 .= '
					' . 'Пожалуйста, подтвердите то, что Вы хотите перестроить мастер-данные следующих плагинов' . $__vars['xf']['language']['label_separator'] . '
				';
	}
