...
';
	...
	if (!$__vars['language']['language_id']) {
		$__compilerTemp4 .= '
			...
			'label' => 'Добавлять данную фразу в глобальный кэш',
			'_type' => 'option',
		)), array(
		)) . '
			';
	...
	<div class="block-container">
		...
		'label' => 'Текст фразы',
		'explain' => 'Вы можете использовать здесь HTML, но в идеале разметка должна быть сделана в шаблонах, а не в фразах.',
	)) . '
