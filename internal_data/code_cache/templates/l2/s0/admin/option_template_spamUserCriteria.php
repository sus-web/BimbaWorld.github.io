...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<dl class="inputLabelPair">
		<dt><label for="spamuc_mc">' . 'Максимальное количество сообщений' . '</label></dt>
	...
	<dl class="inputLabelPair">
		<dt><label for="spamuc_rd">' . 'Максимум дней с момента регистрации' . '</label></dt>
		<dd>' . $__templater->formNumberBox(array(
	...
	<dl class="inputLabelPair">
		<dt><label for="spamuc_tl">' . 'Максимальное количество полученных реакций' . '</label></dt>
		<dd>' . $__templater->formNumberBox(array(
