...
<div class="block">
	<div class="block-container">
		<div class="block-body">
			<a href="' . $__templater->func('link', array('account/language', null, array('language_id' => 0, '_xfRedirect' => $__vars['redirect'], 't' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow">' . 'Использовать язык, выбранный на форуме' . '</a>
