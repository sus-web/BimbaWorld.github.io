...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['interfaceGroup'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить интерфейсную группу');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать интерфейсную группу' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['interfaceGroup']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->form('
	<div class="block-container">
		...
		'value' => '1',
		'label' => 'Эта интерфейсная группа содержит права модератора',
		'_type' => 'option',
	)), array(
	)) . '
