					...
					'html' => '
									...
									<div class="menu" data-menu="menu" aria-hidden="true">
										<div class="menu-content">
											...
											<a href="' . $__templater->func('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['parentIdKey']], ), ), true) . '" class="menu-linkRow">' . 'Родительский' . '</a>
											<a href="' . $__templater->func('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['idKey']], ), ), true) . '" class="menu-linkRow">' . 'Дочерний' . '</a>
										</div>
									</div>
								',
				);
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['category'], 'hasChildren', array())) {
		$__compilerTemp1 .= '
			...
			'value' => 'move',
			'selected' => true,
			'label' => 'Переместить эти дочерние категории в родительскую',
			'_type' => 'option',
		),
		array(
			'value' => 'delete',
