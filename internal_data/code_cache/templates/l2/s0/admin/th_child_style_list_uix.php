	...
	';
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="u-pullRight">' . 'Показано ' . $__templater->func('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' из ' . $__templater->func('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' элементов' . '</span>
			</div>
		</div>
	', array(
