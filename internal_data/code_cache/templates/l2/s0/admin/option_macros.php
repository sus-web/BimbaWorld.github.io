				...
				$__compilerTemp2 .= '
					<div class="block-outer block-outer--after acp--simple">
						<div class="block-outer-middle block-outer-hint">
							' . 'Этот список содержит расширенные параметры, которые могут быть скрыты.' . '
							<a tabindex="0" role="button" data-xf-init="admin-toggle-advanced" data-value="1" data-url="' . $__templater->func('link', array('account/toggle-advanced', ), true) . '">' . 'Включить расширенный режим.' . '</a>
						</div>
					</div>
				';
			}
