...
';
	if ($__vars['tested']) {
		$__finalCompiled .= '
	<div class="blockMessage blockMessage--success blockMessage--iconic">' . 'Тестовое письмо отправлено на адрес ' . $__templater->filter($__vars['xf']['visitor']['email'], array(array('email_display', array()),), true) . '.' . '</div>
';
	}
	$__finalCompiled .= '
