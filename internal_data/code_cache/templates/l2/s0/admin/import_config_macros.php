...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->callMacro(null, 'db_textbox', array(
		'name' => 'tablePrefix',
		'label' => 'Префикс таблиц базы данных',
		'value' => $__vars['value'],
		'placeholder' => $__vars['placeholder'],
		'explain' => $__vars['explain'],
	), $__vars) . '
...
'arguments' => function($__templater, array $__vars) { return array(
		'value' => null,
		'placeholder' => null,
		'explain' => 'Если Вы указали какую-либо кодировку в конфигурации для импортируемой системы, то Вам необходимо указать эту же кодировку и здесь.',
	); },
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	...
	' . $__templater->callMacro(null, 'db_textbox', array(
		'name' => 'charset',
		'label' => 'Принудительная кодировка',
		'value' => $__vars['value'],
		'placeholder' => $__vars['placeholder'],
		'explain' => $__vars['explain'],
	), $__vars) . '
