...
';
	...
	<div class="block-container">
		...
		'explain' => 'На следующей странице можно применить настройки ко всем выделенным префиксам. Если необходимо, чтобы эти настройки базировались на основе существующего префикса, то выберите его здесь.',
	)) . '
		</div>
