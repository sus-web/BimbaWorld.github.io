	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'_dependent' => array('
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_h">' . 'Хранить черновики X часов' . '</label></dt>
		...
		'min' => '1',
			...
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_s">' . 'Сохранять черновики каждые X секунд' . '</label></dt>
				<dd>' . $__templater->formNumberBox(array(
