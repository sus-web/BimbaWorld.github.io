...
';
	if ($__vars['testSuccess'] AND $__vars['xf']['visitor']['email']) {
		$__finalCompiled .= '
	<div class="blockMessage blockMessage--success blockMessage--iconic">' . 'Тестовое сообщение сводки активности успешно отправлено на ' . $__templater->filter($__vars['xf']['visitor']['email'], array(array('email_display', array()),), true) . '.' . '</div>
';
	}
	$__finalCompiled .= '
