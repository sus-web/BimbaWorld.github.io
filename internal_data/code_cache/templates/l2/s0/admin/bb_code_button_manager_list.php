...
<div class="block">
	<div class="block-container">
		<h2 class="block-header">
			...
			<span class="block-desc">' . 'Полнотекстовый редактор поддерживает в общей сложности четыре возможных конфигурации кнопок, которые применяются в зависимости от размера экрана устройства пользователя.' . '</span>
		</h2>
