...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="' . $__templater->escape($__vars['class']) . '"
		...
		<div class="' . $__templater->escape($__vars['class']) . '-opposite quickFilter">
			<input type="text" class="input js-permissionFilterInput" placeholder="' . 'Отфильтровать' . $__vars['xf']['language']['ellipsis'] . '" />
		</div>
	</div>
