...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['prefixGroup'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить группу префиксов');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать группу префиксов' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['prefixGroup']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
