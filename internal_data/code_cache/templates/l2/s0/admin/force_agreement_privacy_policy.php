...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Обязательное согласие с политикой конфиденциальности');
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->escape($__vars['xf']['privacyPolicyUrl']) . '" target="_blank">' . 'Политика конфиденциальности' . ' &middot; ' . 'Последнее обновление' . $__vars['xf']['language']['label_separator'] . ' ' . $__compilerTemp1 . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
