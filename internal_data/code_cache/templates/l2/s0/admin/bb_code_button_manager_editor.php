...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<script class="js-extraPhrases" type="application/json">
		{
			"buttons_menus_may_not_be_duplicated": "' . $__templater->filter('Кнопки и меню не могут быть продублированы.', array(array('escape', array('json', )),), true) . '",
...
';
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Редактор панелей инструментов' . '</h3>
			' . $__compilerTemp1 . '
		</div>
	</div>
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-row block-row--minor u-muted">
				' . 'Это список всех кнопок редактора, которые можно в него добавить. Нижняя строка содержит доступные настраиваемые выпадающие меню. Переместите кнопки отсюда на панель инструментов ниже.' . '
			</div>
		</div>
	</div>
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'data-min-height' => '50',
		'data-max-height' => '100',
		'placeholder' => 'Это предварительный просмотр макета Ваших кнопок' . '...',
		'data-deferred' => 'off',
		'data-xf-key' => 'r',
