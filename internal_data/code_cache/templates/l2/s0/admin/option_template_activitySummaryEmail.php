	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'_dependent' => array('
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_min">' . 'Начать отправлять электронные письма сводки активности, если пользователь был неактивен' . '</label></dt>
				<dd>
		...
		'id' => $__vars['inputName'] . '_min',
						...
						<span class="inputGroup-text">' . 'Дней' . '</span>
					</div>
				</dd>
			</dl>

			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_freq">' . 'Отправлять электронные письма со сводками активности, если пользователь неактивен каждые' . '</label></dt>
				<dd>
					<div class="inputGroup">
						' . $__templater->formNumberBox(array(
		...
		'id' => $__vars['inputName'] . '_freq',
			...
			<dl class="inputLabelPair">
				<dt><label for="' . $__templater->escape($__vars['inputName']) . '_max">' . 'Прекратить отправку элетронных писем со сводками активности, если пользователь не был активен' . '</label></dt>
				<dd>
					<div class="inputGroup">
						' . $__templater->formNumberBox(array(
