...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['group'] ? $__templater->escape($__vars['group']['title']) : 'Негруппированные свойства'));
	$__finalCompiled .= '
';
	if ($__vars['group']) {
		$__finalCompiled .= '
