...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['style']['style_id']) {
		$__compilerTemp2[] = array(
			...
			'submit' => 'true',
			'tooltip' => 'Включить / отключить выбор пользователя \'' . $__vars['style']['title'] . '\'',
			'_type' => 'toggle',
			'html' => '',
		);
		$__compilerTemp2[] = array(
	...
	if ($__vars['style']['style_id']) {
		...
		if ($__vars['canSupportStyleArchives']) {
			$__compilerTemp3 .= '
							<a href="' . $__templater->func('link', array('styles/export-archive', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Экспортировать как архив' . '</a>
						';
		}
		$__compilerTemp2[] = array(
			'label' => '&#8226;&#8226;&#8226;',
			...
			'html' => '
				<div class="menu" data-menu="menu" aria-hidden="true" data-menu-builder="dataList">
					<div class="menu-content">
						<h3 class="menu-header">' . 'Дополнительно' . '</h3>
						<a href="' . $__templater->func('link', array('styles/export', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Экспортировать как XML' . '</a>
						' . $__compilerTemp3 . '
