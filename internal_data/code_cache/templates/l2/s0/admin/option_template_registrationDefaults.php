...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="u-inputSpacer">
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_cws">' . 'Отслеживать темы при создании или ответе в них' . '</label></dt>
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_iws">' . 'Отслеживать содержимое при взаимодействии с ним' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_avp">' . 'Просматривать содержимое страницы профиля' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_app">' . 'Оставлять сообщения на странице профиля этого пользователя' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_aspc">' . 'Вступать в личную переписку с этим пользователем' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
