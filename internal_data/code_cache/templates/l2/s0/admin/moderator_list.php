			...
			<div class="block-outer">
				<div class="block-outer-main">
					<a class="button button--link menuTrigger"
						...
						tabindex="0"
						aria-expanded="false"
						aria-haspopup="true">' . 'Отфильтровать' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['userIdFilter'] ? $__templater->escape($__vars['users'][$__vars['userIdFilter']]['username']) : $__vars['xf']['language']['parenthesis_open'] . 'Все' . $__vars['xf']['language']['parenthesis_close']) . '</a>
