...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'label' => 'Идентификатор задания планировщика',
	)) . '
		...
		'readOnly' => (!$__templater->method($__vars['entry'], 'canEdit', array())),
			...
			', array(
		'rowtype' => 'input',
		'label' => 'Обработчик задания планировщика',
	)) . '
	...
	array(
		...
		'label' => 'Выполнять по часам',
		'explain' => 'Время выполнения основано на часовом поясе UTC.',
	)) . '
	...
	array(
		...
		'label' => '
					' . 'Разрешить выполнение данного задания планировщика' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
