...
';
	...
	<ul class="inputList">
		...
		'value' => 'include',
		'label' => 'Включить выбранное',
		'_type' => 'option',
	),
	array(
		'value' => 'exclude',
		'label' => 'Исключить выбранное',
		'_type' => 'option',
	))) . '</li>
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'explain' => 'Верно, если темы состоит в одной или нескольких выбранных группах.',
	)) . '
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'explain' => 'Верно, если темы не состоит ни в одной из выбранных групп.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Созданные последними',
		'explain' => 'Используйте 0, чтобы указать отсутствие ограничений.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Последнее сообщение в последнем',
		'explain' => 'Используйте 0, чтобы указать отсутствие ограничений.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Количество голосов между',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Количество реакций к первому сообщению между',
	)) . '
