...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Модерация - Объединить сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Вы действительно хотите объединить ' . $__templater->escape($__vars['total']) . ' сообщения вместе?', array(
		'rowtype' => 'confirm',
	)) . '
