...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Загрузка вложения');
	$__finalCompiled .= '
...
';
	...
	if ($__vars['canUpload']) {
		$__compilerTemp4 .= '
			...
			'explain' => 'Вы можете закрыть это окно/вкладку, как только загрузили свои файлы, чтобы вернуться к Вашему содержимому.',
		)) . '
			';
