...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Модерация - Удалить темы');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Вы действительно хотите удалить ' . $__templater->escape($__vars['total']) . ' тем?', array(
		'rowtype' => 'confirm',
	)) . '
