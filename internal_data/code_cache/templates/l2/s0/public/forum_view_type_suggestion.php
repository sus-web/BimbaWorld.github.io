...
'thread_list_header' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<h2 class="block-tabHeader tabs">
		<div class="hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				...
				<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['newest']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['newest']['selected'] ? 'is-active' : '') . '" rel="nofollow">' . 'Новое' . '</a>
				';
	...
	if ($__vars['suggestionTabs']['yourSuggestions']) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['yourSuggestions']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['yourSuggestions']['selected'] ? 'is-active' : '') . '" rel="nofollow">' . 'Мои предложения' . '</a>
				';
	}
	$__finalCompiled .= '
				';
	if ($__vars['suggestionTabs']['yourVotes']) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('forums', $__vars['forum'], $__vars['suggestionTabs']['yourVotes']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['suggestionTabs']['yourVotes']['selected'] ? 'is-active' : '') . '" rel="nofollow">' . 'Мои голоса' . '</a>
				';
	}
	$__finalCompiled .= '
				' . '
