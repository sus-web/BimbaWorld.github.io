...
<div class="menu-footer menu-footer--close menu-footer--split">
	<div class="menu-footer-opposite">
		<a href="https://giphy.com" target="_blank"><img src="' . $__templater->func('base_url', array('styles/default/xenforo/giphy.png', ), true) . '" alt="' . $__templater->filter('Работает на платформе GIPHY', array(array('for_attr', array()),), true) . '" style="width: 100px" /></a>
	</div>
</div>';
