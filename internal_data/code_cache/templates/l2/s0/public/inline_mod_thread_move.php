...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Модерация - Переместить темы');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы действительно хотите переместить ' . $__templater->escape($__vars['total']) . ' тем?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Применить префикс к выделенным темам',
		'_dependent' => array('
		...
		'label' => 'Оповестить пользователей, отслеживающих форум назначения',
		'_type' => 'option',
	)), array(
	)) . '
