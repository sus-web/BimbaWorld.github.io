...
';
	...
	' . $__templater->callMacro('activity_summary_macros', 'outer_header', array(
			'title' => 'Сводка активности того, что Вы недавно пропустили',
		), $__vars) . '
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" class="container container--outer">
	<tr>
		<td align="center" valign="top">
			<p class="minorText">' . 'Если Вы больше не хотите получать эти электронные письма, то можете <a href="' . $__templater->func('link', array('canonical:email-stop/activity-summary', $__vars['xf']['toUser'], ), true) . '">отключить электронные письма о сводках активности</a> или <a href="' . $__templater->func('link', array('canonical:email-stop/all', $__vars['xf']['toUser'], ), true) . '">отключить все электронные письма</a>.' . '</p>
		</td>
	</tr>
</table>';
