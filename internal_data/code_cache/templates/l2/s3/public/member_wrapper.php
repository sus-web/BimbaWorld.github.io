...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['options']['enableMemberList']) {
		$__compilerTemp2 .= '
					<a class="blockLink ' . (($__vars['pageSelected'] == 'member_list') ? 'is-selected' : '') . '" href="' . $__templater->func('link', array('members/list', ), true) . '">' . 'Зарегистрированные пользователи' . '</a>
				';
	}
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-body">
				<a class="blockLink ' . (($__vars['pageSelected'] == 'overview') ? 'is-selected' : '') . '" href="' . $__templater->func('link', array('members', ), true) . '">' . 'Обзор' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</div>
		</div>
...
', 'replace');
	$__finalCompiled .= '
';
	$__templater->setPageParam('sideNavTitle', 'Пользователи');
	$__finalCompiled .= '
