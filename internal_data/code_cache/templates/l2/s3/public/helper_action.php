...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['canEditSilently']) {
		...
		' . $__templater->formCheckBox(array(
			...
			'hint' => 'Если выбрано, то примечание "Последнее редактирование" не будет добавлено к сообщению.',
			'_dependent' => array($__templater->formCheckBox(array(
		), array(array(
			'name' => $__vars['clearEditName'],
			'checked' => $__vars['clearEdit'],
			'label' => 'Очистить информацию о последнем редактировании',
			'hint' => 'Если выбрано, любое имеющееся примечание "Последнее редактирование" будет удалено.',
			'_type' => 'option',
		)))),
			'_type' => 'option',
		))) . '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['canHardDelete']) {
		...
		array(
			...
			'hint' => 'Выбор этой опции удалит элемент полностью и безвозвратно.',
			'_type' => 'option',
		)), array(
			'label' => 'Тип удаления',
		)) . '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['checkbox'] = $__templater->preEscaped('
		...
		'afterhint' => 'Обратите внимание, что автор увидит это оповещение, даже если он больше не сможет посмотреть своё сообщение.',
		'_type' => 'option',
	))) . '
	');
	$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formCheckBoxRow(array(
		...
		'afterhint' => 'Обратите внимание, что автор темы увидит это оповещение, даже если он больше не сможет посмотреть свою тему.',
		'_type' => 'option',
	)), array(
	)) . '
';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'label' => 'Примечание о переадресации',
	)) . '
';
	return $__finalCompiled;
}
