...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Модерация - Копировать сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы действительно хотите скопировать ' . $__templater->escape($__vars['total']) . ' сообщений в новую тему?', array(
		'rowtype' => 'confirm',
	)) . '
