<?php
// FROM HASH: 8231b5b6696494f599783e43f9dfd35b
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
				';
	if ($__templater->func('property', array('xentr_collapse_nodes', ), false)) {
		$__finalCompiled .= '
					<span id="collapse-' . $__templater->escape($__vars['node']['node_id']) . '" class="collapseTrigger collapseTrigger--block ' . ((!$__templater->func('is_toggled', array('_node-' . $__vars['node']['node_id'], ), false)) ? ' is-active' : '') . '" data-xf-click="toggle" data-xf-init="toggle-storage" data-storage-type="cookie" data-target=".block--category' . $__templater->escape($__vars['node']['node_id']) . ' .block-body" data-storage-key="_node-' . $__templater->escape($__vars['node']['node_id']) . '"></span>
				';
	}
	$__finalCompiled .= '	
			</h2>
				...
				<div class="node-extra-content">
					<div class="node-extra-content-left">
						<div class="node-extra-footer-main">
							<div class="node-extra-footer-title">' . $__templater->escape($__vars['node']['title']) . '</div>		
					...
					<div class="node-extra-content-right">
						<a href="#top" class="button--scroll" data-xf-click="scroll-to">' . $__templater->fontAwesome('fa-arrow-up', array(
