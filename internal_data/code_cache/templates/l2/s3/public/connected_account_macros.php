...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	$__vars['explain'] = ((((!$__vars['hasPassword']) AND ($__templater->func('count', array($__vars['xf']['visitor']['Profile']['connected_accounts'], ), false) == 1))) ? 'Разрыв связи со всеми внешними учётными записями приведет к созданию пароля для Вашего аккаунта и его отправке по электронной почте: ' . $__templater->filter($__vars['xf']['visitor']['email'], array(array('email_display', array()),), false) . '.' : '');
	$__finalCompiled .= '
	' . $__templater->formRow('
