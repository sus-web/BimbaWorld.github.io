...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['user']['user_id'] AND $__templater->method($__vars['xf']['visitor'], 'canStartConversationWith', array($__vars['user'], ))) {
		$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('conversations/add', '', array('to' => $__vars['user']['username'], ), ), true) . '" data-xf-click="' . 'overlay' . '" class="xm-icon button--link"><i class="fas fa-envelope" aria-hidden="true" data-xf-init="tooltip" title="' . 'Начать переписку' . '"></i></a>
				';
	}
	$__finalCompiled .= '
			</h4>
