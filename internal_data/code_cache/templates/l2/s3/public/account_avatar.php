...
';
		...
		$__compilerTemp1 .= '
			...
			'value' => '1',
									...
									<dfn class="inputChoices-explain">
										' . 'Введите адрес электронной почты, с которым Вы зарегистрированы в сервисе Gravatar.' . '
	...
	<div class="block-container">
		...
		'hint' => 'Перетащите изображение, чтобы его обрезать, затем нажмите "<i>Ок</i>" для подтверждения, или загрузите новый аватар ниже.',
		'_dependent' => array('
		...
		'accept' => '.gif,.jpeg,.jpg,.jpe,.png',
								...
								<dfn class="inputChoices-explain">
									' . 'Рекомендуется использовать изображение, которое будет как минимум ' . 400 . 'x' . 400 . ' пикселей.' . '
								</dfn>
							'),
		'_type' => 'option',
	))) . '
