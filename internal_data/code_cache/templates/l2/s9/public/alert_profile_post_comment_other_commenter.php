...
';
		...
		$__finalCompiled .= '
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['alert']['username'], ), ), true) . ' также прокомментировал(а) <a ' . (('href="' . $__templater->func('link', array('profile-posts/comments', $__vars['content'], ), true)) . '" class="fauxBlockLink-blockLink"') . '>сообщение профиля</a>, которое написал(а) ' . $__templater->escape($__vars['content']['ProfilePost']['username']) . '' . '
';
	}
