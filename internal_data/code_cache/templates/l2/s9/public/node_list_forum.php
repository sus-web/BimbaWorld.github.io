<?php
// FROM HASH: 2fe87521ab1ca3b8c0c1092e66cc1af4
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="node node--id' . $__templater->escape($__vars['node']['node_id']) . ' node--depth' . $__templater->escape($__vars['depth']) . ' node--forum ' . ($__vars['extras']['hasNew'] ? 'node--unread' : 'node--read') . '">
		';
	if ($__templater->func('property', array('xmNodeLayout', ), false) == 'default') {
		$__finalCompiled .= '
		<div class="node-body">
	...
	if (($__templater->func('property', array('xmNodeLayout', ), false) == 'classic')) {
		$__finalCompiled .= '
			' . $__templater->includeTemplate('xtr_node_list_classic', $__vars) . '
		';
	}
	$__finalCompiled .= '
		';
	if (($__templater->func('property', array('xmNodeLayout', ), false) == 'classicImage')) {
		$__finalCompiled .= '
			' . $__templater->includeTemplate('xtr_node_list_classic_image', $__vars) . '
		';
	}
	$__finalCompiled .= '
		';
	if (($__templater->func('property', array('xmNodeLayout', ), false) == 'dual')) {
		$__finalCompiled .= '
			' . $__templater->includeTemplate('xtr_node_list_dual', $__vars) . '
		';
	}
	$__finalCompiled .= '
	</div>
