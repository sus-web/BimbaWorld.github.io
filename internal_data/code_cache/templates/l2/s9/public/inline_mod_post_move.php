...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Модерация - Переместить сообщения');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Вы действительно хотите переместить ' . $__templater->escape($__vars['total']) . ' сообщений в новую тему?', array(
		'rowtype' => 'confirm',
	)) . '
		...
		'label' => 'Новая тема',
		'_dependent' => array('
						<label>' . 'Форум назначения' . $__vars['xf']['language']['label_separator'] . '</label>
