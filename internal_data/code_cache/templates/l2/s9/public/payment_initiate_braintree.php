...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Введите данные платежа');
	$__finalCompiled .= '
...
<div class="blocks">
	' . $__templater->form('
		...
		'id' => 'brand-icon',
					...
					<div class="formRow-explain">' . 'Платежи безопасно обрабатываются сервисом <a href="' . 'https://braintreepayments.com/' . '" target="_blank">' . 'Braintree' . '</a>. Мы не обрабатываем и не храним Ваши платёжные реквизиты.' . '</div>
				', array(
