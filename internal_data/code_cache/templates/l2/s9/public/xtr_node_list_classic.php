	...
	if (!$__vars['extras']['privateInfo']) {
		...
		<div class="node-stats">
			<div class="node-threads">
				<div class="node-stats-bg" data-xf-init="tooltip" title="' . 'Темы' . '">				
					' . $__templater->filter($__vars['extras']['discussion_count'], array(array('number_short', array(1, )),), true) . '
					<div class="stats-mark"></div>
				</div>
			</div>
			<div class="node-messages" data-xf-init="tooltip" title="' . 'Сообщения' . '"><i class="fas fa-comment-dots"></i> ' . $__templater->filter($__vars['extras']['message_count'], array(array('number_short', array(1, )),), true) . '</div>
		</div>
    ';
	}
	$__finalCompiled .= '
