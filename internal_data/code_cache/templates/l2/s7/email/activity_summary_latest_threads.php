...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		';
			...
			' . 'Форум' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('canonical:forums', $__vars['thread']['Forum'], ), true) . '">' . $__templater->escape($__vars['thread']['Forum']['title']) . '</a>
		');
				$__finalCompiled .= '
		';
				$__vars['footerOpposite'] = $__templater->preEscaped('
			<a href="' . $__templater->func('link', array('canonical:threads', $__vars['thread'], ), true) . '" class="button button--link">' . 'Читать далее' . '</a>
		');
				$__finalCompiled .= '
