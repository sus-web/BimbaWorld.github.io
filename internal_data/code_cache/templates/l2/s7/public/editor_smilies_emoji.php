...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="menu-emojiInsertedMessage">
		' . 'Вставлено' . $__vars['xf']['language']['label_separator'] . ' <span class="js-emojiInsert"></span>
	</div>
</div>
...
<div class="menu-scroller js-emojiFullList">
	<h3 class="menu-header js-recentHeader ' . ((!$__vars['recent']) ? 'is-hidden' : '') . '">' . 'Недавно использованные' . '</h3>
	...
	if ($__templater->isTraversable($__vars['smilieCategories'])) {
		...
		';
			...
			if (strlen(trim($__compilerTemp1)) > 0) {
				$__finalCompiled .= '
			<h3 class="menu-header">' . ($__vars['categoryId'] ? $__templater->escape($__vars['category']['title']) : 'Смайлы') . '</h3>
			<div class="menu-row">
