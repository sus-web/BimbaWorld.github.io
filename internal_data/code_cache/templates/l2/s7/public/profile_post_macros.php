<?php
// FROM HASH: aa4c0ddece4c8eabe3a50d7a28109b38
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['showTargetUser'] AND ($__vars['profilePost']['user_id'] != $__vars['profilePost']['profile_user_id'])) {
		...
		<span class="u-srOnly">' . '' . ($__templater->escape($__vars['profilePost']['User']['username']) ?: $__templater->escape($__vars['profilePost']['username'])) . ' написал(а) в профиле ' . ($__templater->escape($__vars['profilePost']['ProfileUser']['username']) ?: 'Неизвестно') . '.' . '</span>
	';
	} else {
		$__finalCompiled .= '
		' . $__templater->func('username_link', array($__vars['profilePost']['User'], true, array(
			...
			$__finalCompiled .= '
										<div class="message-responseRow u-jsOnly js-commentLoader">
											<a href="' . $__templater->func('link', array('profile-posts/load-previous', $__vars['profilePost'], array('before' => $__templater->arrayKey($__templater->method($__vars['profilePost']['LatestComments'], 'first', array()), 'comment_date'), ), ), true) . '"
											   ...
											   rel="nofollow">' . 'Показать предыдущие комментарии' . $__vars['xf']['language']['ellipsis'] . '</a>
										</div>
									';
		}
		$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->form('
		...
		'attachmentData' => $__vars['attachmentData'],
		'simple' => true,
		'placeholder' => (($__vars['xf']['visitor']['user_id'] == $__vars['user']['user_id']) ? 'Обновить свой статус' . $__vars['xf']['language']['ellipsis'] : 'Напишите что-нибудь' . $__vars['xf']['language']['ellipsis']),
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['placeholder'] = (($__vars['xf']['visitor']['user_id'] == $__vars['user']['user_id']) ? 'Обновить свой статус' . $__vars['xf']['language']['ellipsis'] : 'Напишите что-нибудь' . $__vars['xf']['language']['ellipsis']);
	$__finalCompiled .= '
