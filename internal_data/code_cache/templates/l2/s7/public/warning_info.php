...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Предупреждение для ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
	...
	if ($__templater->method($__vars['warning'], 'canDelete', array()) AND $__templater->method($__vars['warning'], 'canEditExpiry', array())) {
		$__finalCompiled .= '
			<h2 class="block-tabHeader tabs" data-xf-init="tabs" role="tablist">
				<a class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('warningDelete', ), true) . '">' . 'Удалить' . '</a>
				<a class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('warningUpdate', ), true) . '">' . 'Обновить' . '</a>
			</h2>
			<ul class="tabPanes">
