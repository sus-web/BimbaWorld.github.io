...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Баннер профиля');
	$__finalCompiled .= '
	...
	<div class="block-container">
		...
		'class' => 'js-bannerPosY',
				...
				<div class="profileBannerContainer-explain">
					' . 'Вы можете перетащить изображение, а затем нажать "Okay" для подтверждения.' . '
				</div>
			', array(
		'rowtype' => 'noPadding',
		...
		'label' => 'Загрузить новый баннер профиля',
	)) . '
		</div>
