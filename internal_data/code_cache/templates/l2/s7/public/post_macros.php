<?php
// FROM HASH: 7fc904302d6b20d932c952aceb28cb89
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['post']['is_question_solution']) {
		$__finalCompiled .= '
				<li class="uix_solutionAttribution">				
					<span class="is-solution" data-xf-init="tooltip" title="' . 'Решение' . '">' . $__templater->fontAwesome('fa-check-circle', array(
		)) . ' ' . 'Решение' . '</span>
				</li>
			';
	}
	...
	if ($__templater->method($__vars['post'], 'isUnread', array())) {
		...
		$__finalCompiled .= '
				<li><span class="message-newIndicator">' . 'Новые ответы' . '</span></li>
			';
	}
	$__finalCompiled .= '
			<li>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (($__templater->func('property', array('uix_voteActionButton', ), false) != 'never')) {
		...
		$__compilerTemp1 .= '
				...
				';
		if ($__templater->method($__vars['thread'], 'isContentVotingSupported', array()) AND $__templater->method($__vars['post'], 'isFirstPost', array())) {
			$__compilerTemp1 .= '
					<span class="actionBar-action actionBar-action--vote">
						' . $__templater->callMacro('content_vote_macros', 'vote_control', array(
				'link' => 'threads/vote',
