	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				' . 'Вы уверены, что хотите повторить отправку письма для активации учётной записи? Ссылки во всех предыдущих письмах перестанут работать. Уведомление будет отправлено на адрес ' . $__templater->filter($__vars['user']['email'], array(array('email_display', array()),), true) . '.' . '
			', array(
		'rowtype' => 'confirm',
	)) . '
