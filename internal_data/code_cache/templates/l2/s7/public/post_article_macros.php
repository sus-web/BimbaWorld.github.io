<?php
// FROM HASH: 8120c0e02efe033e941b7dfa4e3e5bb4
return array(
	...
	if ($__vars['isListItem']) {
		...
		if ($__vars['thread']['discussion_state'] == 'moderated') {
			$__finalCompiled .= '
				...
				'aria-hidden' => 'true',
				'title' => $__templater->filter('В ожидании одобрения', array(array('for_attr', array()),), false),
			)) . '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
				...
				<div class="articlePreview-links">
					...
					<a href="' . $__templater->escape($__vars['link']) . '">' . 'Посмотреть полную статью' . ' &gt;</a>
				</div>
			</div>
		</div>
		...
		'defaultname' => $__vars['thread']['username'],
				...
				<li class="articlePreview-by">' . 'От ' . $__templater->escape($__vars['username']) . '' . '</li>
